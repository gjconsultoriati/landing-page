...
export function LineUpServicesCards({
  ...
  return (
    <div className="mt-[30px] px-2">
      <div className=" rounded-[8px] bg-black-50  shadow-xl   max-sm:h-[420px]  max-sm:w-[250px]">
        <div className="flex h-[180px] flex-col items-center justify-center">
          <Image
            src={source}
            alt=""
            className="rounded-t-[8px]  border border-gray-800 shadow-lg max-sm:h-[180px]"
          />
        </div>
        <div className="bg-black-50 max-sm:h-[230px] max-sm:px-2 max-sm:py-4">
